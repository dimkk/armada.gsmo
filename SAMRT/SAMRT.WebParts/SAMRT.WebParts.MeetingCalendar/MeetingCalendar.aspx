...
<%@ Register Src="~/_controltemplates/15/SAMRT/CalendarUserControl.ascx" TagPrefix="myControls" TagName="CalendarUserControl" %>
<%@ Register Src="~/_controltemplates/15/SAMRT/LastProtocolsUserControl.ascx" TagPrefix="myControls" TagName="LastProtocolsUserControl" %>
<%@ Register Src="~/_controltemplates/15/SAMRT/NextMeetingUserControl.ascx" TagPrefix="myControls" TagName="NextMeetingUserControl" %>
...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <table>
       <tr>
           ...
           <td style="vertical-align:top; width: 230px;"><myControls:NextMeetingUserControl Title="Архитектурная комиссия" MeetingsListName="АК - Заседания" MeetingStatusFieldName="MeetingStatus" MeetingDateFieldName="MeetingDate" runat="server" /></td>
       </tr>
