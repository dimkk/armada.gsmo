...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeetingMVK.aspx.cs" Inherits="SAMRT.Web.MeetingMvk" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="<%= SPUtility.MakeBrowserCacheSafeLayoutsUrl("SAMRT.Web/Content/typeahead.js-bootstrap.css", false) %>" />
    <link rel="stylesheet" type="text/css" href="<%= SPUtility.MakeBrowserCacheSafeLayoutsUrl("SAMRT.Web/Content/moment-datepicker/datepicker.css", false) %>" />
    <link rel="Stylesheet" type="text/css" href="<%= SPUtility.MakeBrowserCacheSafeLayoutsUrl("SAMRT.Web/Content/App.css", false) %>" />

    <!-- Добавьте свой код JavaScript в следующий файл -->
    <script type="text/javascript" src="<%= SPUtility.MakeBrowserCacheSafeLayoutsUrl("SAMRT.Web/Scripts/spin.min.js", false) %>"></script>
    <script type="text/javascript" src="<%= SPUtility.MakeBrowserCacheSafeLayoutsUrl("SAMRT.Web/Scripts/camljs.js", false) %>"></script>
    <script type="text/javascript" src="<%= SPUtility.MakeBrowserCacheSafeLayoutsUrl("SAMRT.Web/Scripts/Meeting/viewmodel.js", false) %>"></script>
