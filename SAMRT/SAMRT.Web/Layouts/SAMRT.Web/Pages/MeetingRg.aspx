...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeetingRg.aspx.cs" Inherits="SAMRT.Web.MeetingRg" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="../Scripts/Model/MeetingRg.js"></script>
            ...
            <div id="tab-common" class="tab-pane fade active in">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="AgendaQuestionTableDiv">
                        <table class="table evenodd" id="AgendaQuestionTableTable">
                            ...
                            <tbody data-bind="foreach: agendaQuestions">
                                <tr>
                                    ...
                                    <td data-bind="text: IssueNumberMVK"></td>
                                    <td data-bind="text: IssueAddressMVK"></td>
                                    <td data-bind="text: OrderBuilderMVK() !== null ? OrderBuilderMVK().get_lookupValue() : null"></td>
                        ...
                        <button type="button" class="btn btn-default" data-bind="click: addOrderRg">Добавить из заявок Рабочей группы</button>
