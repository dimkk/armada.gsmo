...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Meeting.aspx.cs" Inherits="SAMRT.Web.Meeting" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="<%= SPUtility.MakeBrowserCacheSafeLayoutsUrl("SAMRT.Web/Scripts/viewmodel.js", false) %>"></script>
