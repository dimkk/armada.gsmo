...
(function () {
    ...
    function loadMetadataInfo(callback) {
        for (var item in modelMetaData) {
            //modelMetaData[item].contentTypes = $.appWebContext.get_web().get_lists().getById(modelMetaData[item].listId).get_contentTypes();
    ...
    function agendaQuestion(data) {
        ...
        this.httpLink = ko.observable(
            (String).format("{0}//{1}/Lists/IssueMVKList/DispForm2.aspx?ID={2}&ContentTypeId={3}",
                ...
                $.appWebContext.executeQueryAsync(function () {
                    try
                    {
                        ...
                        while (enumerator.moveNext()) {
                            ...
                            if (newQuest.IssueReporterMVK() != null)
                                allMeetingBaseParticipants.push(newQuest.IssueReporterMVK());
                            if (newQuest.IssueCoReportersMVK != null)
                                $.each(newQuest.IssueCoReportersMVK(),
