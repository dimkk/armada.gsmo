                        ...
                        <table class="table">
                            ...
                            <tbody data-bind="foreach: agendaQuestions">
                                <tr>
                                    ...
                                    <td data-bind="text: agendaQuestionReporterFIO"></td>
                                    <td data-bind="text: QuestionCategoryLinkValue"></td>
                                    <td data-bind="text: AgendaQuestionProtocolDecision"></td>
                                    <td>
                                ...
                                <tr>
                                    <td class="cell-no-top-border"></td>
                                    <td colspan="4">
                                        ...
                                        <div class="container">
                                            <div class="panel-group" id="addQuestionDlgAccordion">
                                                <div class="panel panel-default">
                                                    ...
                                                    <div id="addQcommon" class="panel-collapse collapse in">
                                                        <div class="panel-body">
                                                            <div class="container">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="container">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select class="form-control" data-bind="options: $root.agendaQuestionTypes, optionsText: 'Name', optionsCaption: 'Выберите значение', value: editQuestionType, enable: $root.editEnabled"></select>
                                                                </div>
                                                                <br/>
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">Решение</span>
                                                                    <select class="form-control" data-bind="value: editAgendaQuestionProtocolDecision, enable: $root.editEnabled">
                                                                        <option value="" label=""></option>
                                                                        <option value="1" label="Согласиться"></option>
                                                                        <option value="0" label="Отказаться"></option>
                                                                    </select>
                                                                </div>
                                                                <br/>
                                                                <label>Градостроительные показатели</label>
                                                                <br/>
                                                                <table class="table">
                                                                    <thead>
                                                                        <tr>
                                                                    ...
                                                                    <tbody data-bind="foreach: editAgendaQuestionMeasures">
                                                                        <tr>
                                                                            <td data-bind="text: MeasureType"></td>
                                                                            <td><input data-bind="value: Value" type="text" class="form-control" /></td>
                                                    ...
                                                    <div id="addQadditional" class="panel-collapse collapse">
                                                        <div class="panel-body">
                                                            <div class="container">
                                                                ...
                                                                <br />
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">Заявитель</span>
                                                                    <input data-bind="value: editAgendaQuestionDeclarant, enable: $parent.editEnabled" type="text" id="inputRequesterDlg" class="form-control" placeholder="Укажите заявителя на комиссию" />
                                                                </div>
                                                                <br />
                                                                <div class="input-group">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h4 class="panel-title">
                                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#addQuestionDlgAccordion" href="#addQOutcome">Решение и вложения</a>
                                                        </h4>
                                                    </div>
                                                    <div id="addQOutcome" class="panel-collapse collapse">
                                                        <div class="panel-body">
                                                            <textarea data-bind="value: editAgendaQuestionProtocolDecision, enable: $parent.editEnabled" class="form-control" rows="4"></textarea>
                                                                    ...
                                                                    <div class="form-horizontal" role="form">
                                                                        <div class="form-group">
                                                                            <div class=" col-lg-4">
                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input type="radio" value="ByDate" data-bind="checked: editAssignmentPlanIsDependent, click: function () { editAssignmentDaysForResolve(''); editAssignmentDayType(''); editAssignmentPredecessorLinkValue(''); }">
                                                                                        Абсолютный
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class=" col-lg-4">
                                                                                <div class="radio">
                                                                                    <label>
                                                                                        <input type="radio" value="ByAssignment" data-bind="checked: editAssignmentPlanIsDependent, click: function () { editAssignmentPlanDate(''); }">
                                                                                        Относительный
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                        ...
                        <table id="other-participant-table" class="table">
                            ...
                            <tbody data-bind="foreach: meeting().additionalParticipants">
                                <tr>
                                    ...
                                    <td data-bind="text: ParticipantPosition"></td>
                                    <td data-bind="text: ParticipantOrg"></td>
                                    <td><button type="button" class="btn btn-default" data-bind="click: $root.meeting().removeAdditionalPartcipant, enable: $root.editEnabled"><span class="glyphicon glyphicon-trash"></span></button></td>
                                </tr>
                            </tbody>
                        </table>
                        <div>
