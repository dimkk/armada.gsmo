    ...
    function renderFields(context) {
        ...
        if (context.ControlMode === SPClientTemplates.ClientControlMode.DisplayForm) {
            ...
            var modalLink = renderCore.bs.renderModalLink(
                "/_layouts/15/gradsovetpages/pages/selectAgendaQuestion.html?rev=" + Math.random().toString(36).substr(2),
                "Выбрать",
                2,
            ...
            modalLink = renderCore.bs.renderModalLink(
                "/_layouts/15/gradsovetpages/pages/selectLinkedAssignment.html?rev=" + Math.random().toString(36).substr(2),
                "Выбрать",
                1,
