...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgendaQuestion.aspx.cs" Inherits="GradSovetPages.Layouts.GradSovetPages.AgendaQuestion" DynamicMasterPageFile="~masterurl/default.master" %>
                    ...
                    <ZoneTemplate>
                        ...
                        <%--<WebPartPages:ListFormWebPart ID="WPAgendaQuestionForm" runat="server"
                            ...
                            <WebPart xmlns:xsd="http://www.w3.org/2001/XMLSchema" 
                              ...
                              <JSLink xmlns="http://schemas.microsoft.com/WebPart/v2/ListForm">~site/_layouts/15/gradsovetpages/Scripts/csr/renderAgendaQuestion.js</JSLink>
                            </WebPart>
                        </WebPartPages:ListFormWebPart>--%>
                    </ZoneTemplate>
                </WebPartPages:WebPartZone>
