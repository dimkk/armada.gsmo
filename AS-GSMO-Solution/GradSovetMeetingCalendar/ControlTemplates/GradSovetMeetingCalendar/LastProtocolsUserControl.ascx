...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LastProtocolsUserControl.ascx.cs" Inherits="GradSovetMeetingCalendar.ControlTemplates.GradSovetMeetingCalendar.LastProtocolsUserControl" %>
