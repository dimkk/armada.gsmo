        ...
        protected string MeetingLoad()
        {
            ...
            try
            {
                ...
                var query = new SPQuery
                    {
                        Query = string.Format("<Where><Or><Eq><FieldRef Name='{0}' /><Value Type='Choice'>Планируемое</Value></Eq><Eq><FieldRef Name='{0}' /><Value Type='Choice'>Planning</Value></Eq></Or></Where><OrderBy><FieldRef Name='{1}' /></OrderBy>", MeetingStatusFieldName, MeetingDateFieldName),
