...
namespace GSWeb.erAssignmentFactDate
{
    ...
    /// List Item Events
    /// </summary>
    public class erAssignmentFactDate : SPItemEventReceiver
    {
        /// <summary>
        ...
        {
            if (EventReceiverExtensions.IsFieldChanged(properties, "AssignmentFactDate"))
            {
                properties.AfterProperties["AssignmentStatus"] = "Исполнено";
                properties.AfterProperties["AssignmentInspectState"] = "Снято с контроля";
            }
